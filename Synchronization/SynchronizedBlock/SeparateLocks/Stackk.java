//Question--If there ae 2 separate locks 1-push() & other lock for pop() then?
package Synchronization.SynchronizedBlock.SeparateLocks;
//STACK --->LIFO Concepts
public class Stackk {
    //1> Attributes
    private int[]array; //stack storage
    private int stackTopIndex;
    Object lock1; //reference of object which can be used as a lock1
    Object lock2; //reference of object which can be used as a lock2
    ...
    public Stackk(int capacity){
        ...
        lock1=new Object();//Instance of object
        lock2=new Object();//Instance of object
    }
